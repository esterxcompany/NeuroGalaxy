...
export const contextTool = tool({
    name: "context",
    description: "Recupera fragmentos de la documentación oficial (Redis) del NASA SpaceApp Challenge. Esta es la fuente principal y autorizada; úsala siempre que sea relevante.",
    parameters: z.object({
